...
<div class="bg-body-tertiary col-md-6 container mx-0 rounded p-4 shadow">
  <form action="{{ route('resident.store') }}" method="POST">
    ...
    <div class="mb-3">
      <input class="form-control" placeholder="Nama" type="text" name="name" value="{{ old('name') }}" required>
      @error('name')
      <span class="text-danger">{{ $message }}</span>
      @enderror
    </div>
    ...
    <div class="d-flex mb-3 gap-3">
      <input class="form-control" placeholder="Tempat lahir" type="text" name="pob" value="{{ old('pob') }}" required>
      <div class="input-group">
        <span class="input-group-text text-secondary">Tanggal lahir</span>
        <input class="form-control" placeholder="Tanggal lahir" type="date" name="dob" value="{{ old('dob') }}" required>
      </div>
    </div>
    ...
    <div class="mb-3">
      <select id="kelurahan_id" name="kelurahan_id" class="form-select" required>
        ...
        <option value="" disabled selected>Sub Ditrict</option>
    ...
    <div class="mb-3">
      <select id="community_unit_id" name="community_unit_id" class="form-select" required>
        ...
        <option value="" disabled selected>Community Unit</option>
