...
@section('content')
  <div class="bg-body-tertiary col-md-6 container mx-0 rounded p-4 shadow">
    <form action="">
      <div class="mb-3">
        <input class="form-control" placeholder="NIK" type="number" value="{{ $communityUnit->head }}">
      </div>
      <div class="mb-3">
        <input class="form-control" placeholder="Nama" type="text" value="{{ $communityUnit->name }}">
      </div>
