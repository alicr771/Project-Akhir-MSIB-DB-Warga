          ...
          <div class="card-body">
            <form action="{{ route('login_proses') }}" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input autocomplete="current-password" class="form-control @error('password') is-invalid @enderror"
              ...
              <div class="row mb-3">
                <div class="col-md-6 offset-md-4">
                  <div class="form-check">
                    <input {{ old('remember') ? 'checked' : '' }} class="form-check-input" id="remember" name="remember"
                      type="checkbox">
